...
main (int argc, char *argv[])
{
  ...
  ueNodes.Get (0)->GetObject<MobilityModel> ()->SetPosition (Vector (10, 0, 1.5));
  ueNodes.Get (1)->GetObject<MobilityModel> ()->SetPosition (Vector (1000, 0, 1.5));
  ueNodes.Get (2)->GetObject<MobilityModel> ()->SetPosition (Vector (3000, 0, 1.5));
  ueNodes.Get (3)->GetObject<MobilityModel> ()->SetPosition (Vector (-10, 0, 1.5));
  ueNodes.Get (4)->GetObject<MobilityModel> ()->SetPosition (Vector (-1000, 0, 1.5));
  ueNodes.Get (5)->GetObject<MobilityModel> ()->SetPosition (Vector (-3000, 0, 1.5));
  ...
  CcBwpCreator::SimpleOperationBandConf bandConf (6e9, 50e6, numCcPerBand);
  ...
  nrHelper->SetGnbPhyAttribute ("TxPower", DoubleValue (23));
  ...
  {
    DynamicCast<NrUeNetDevice> (ueNetDev.Get (i))->UpdateConfig ();
  }
